...
This project serves as the final assignment for two courses simultaneously at Nanjing Xiaozhuang University (南京晓庄学院):

- **J2EE-Based Framework for Enterprise** — demonstrates Servlet, Filter, Session, Cookie, JDBC, and five-tier architecture using Spring Boot
- **Java Design Pattern** — implements 10 GoF patterns explicitly across all three categories

**Author:** Yakhe Kenneth Sugiharto (葛嘉诚) · Student ID: L25020009 · IT-1 · 2026
